                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills nav-justified">
                                <li class="nav-item">
                                    <a class="nav-link bg-primary m-0 font-weight-bold text-white" href="form2.php">FSIC FOR CERTIFICATE OF OCCUPANCY</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link m-0 font-weight-bold text-warning" href="form3.php">FOR NEW BUSINESS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link m-0 font-weight-bold text-info" href="form4.php">FOR RENEWAL  OF BUSINESS</a>
                                </li>
                            </ul>
                            <div class="card-body">
